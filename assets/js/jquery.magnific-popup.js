(function (factory) {
  ...
  MagnificPopup.prototype = {
    ...
    open: function (data) {
      ...
      if (mfp.st.modal) {
        mfp.st.closeOnContentClick = !1;
        mfp.st.closeOnBgClick = !1;
        mfp.st.showCloseBtn = !1;
        mfp.st.enableEscapeKey = !1;
      }
      if (!mfp.bgOverlay) {
    ...
    _close: function () {
      ...
      if (
        mfp.st.showCloseBtn &&
        (!mfp.st.closeBtnInside || mfp.currTemplate[mfp.currItem.type] === !0)
      ) {
        ...
        _mfpOn("BuildControls" + ns, function () {
          if (mfp._allowZoom()) {
            ...
            openTimeout = setTimeout(function () {
              animatedImg.css(mfp._getOffset(!0));
              openTimeout = setTimeout(function () {
                showMainContent();
                setTimeout(function () {
                  animatedImg.remove();
